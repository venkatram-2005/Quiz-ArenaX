...
<head>
    ...
    <title>Edit Questions - ${subjectName}</title>
    <link rel="stylesheet" type="text/css" href="css/admin_viewQuestionsToEdit_styles.css"> <!-- Link to the external CSS -->
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
</head>
<body>
    <div class="container"> <!-- Added container for styling -->
        <h1>Edit Questions for ${subjectName}</h1>
        <table>
            <tr>
                <th>Question</th>
                <th>Options</th>
    ...
    <script type="text/javascript">
        ...
        if (status === "success") {
            ...
            swal("Error", "An error occurred while updating the question!", "error");
        }
    </script>
</body>
</html>
